...
// 
    ...
    //tasks
    grunt.registerTask('default', ['debug','build','pretty']);
    ...
    //
    grunt.registerTask('ugly', "Create the ugly html for deployment",['uglify:ugly','putUglyInConfig','template:ugly','setPostBuildInfo:deploy/App.txt']);
    //
